...
lose = font1.render('ВЫ ПРОИГРАЛИ!',True, (0, 255,0))
...
for i in range(1, 3):
    asteroid = Asteroid(img_asteroid, randint(30, win_width - 30), -40, 80, 50, randint(1, 10))
    ...
    if not finish:
        ...
        if rel_time == True:
            ...
            if now_time - last_time < 3:
                reload_text = font2.render('Не так быстро....', 1, (255, 0, 0))
        ...
        time.delay(3000)
        for i in range(1, 6):
            Enemy(img_enemy, randint(80, win_width - 80), -40, 80, 50, randint(1, 5))
            monsters.add(monster)
        for i in range(1, 3):
            Asteroid(img_asteroid, randint(30, win_width - 30), -40, 80, 50, randint(1, 8))
            asteroids.add(asteroid)
